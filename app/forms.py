...
class ProfileForm(Form):
    name1 = StringField('First Name', validators=[DataRequired('Your first name is required!')])
    name2 = StringField('Last Name', validators=[DataRequired('Your Last name is required!')])
